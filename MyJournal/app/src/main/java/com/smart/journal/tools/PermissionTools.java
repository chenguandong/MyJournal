...
public class PermissionTools {
    ...
    public static void checkPermission(final Activity context, PermissionType permissionType,
        ...
        rxPermissions.request(permissions).subscribe(consumer);
    }
     ...
     * "android.permission.READ_CALL_LOG", "android.permission.WRITE_CALL_LOG", "android.permission.USE_SIP",
    ...
    public enum PermissionType {
        PERMISSION_TYPE_LOCATION, PERMISSION_TYPE_STORAGE, PERMISSION_TYPE_CAMERA
    }
