...
class MoreSettingItemView : LinearLayout {
    ...
    private fun refreshColor() {
        ...
        when (itemBean!!.subTitle) {
            resources.getString(R.string.favourite) -> logoImageView.setColorFilter(ContextCompat.getColor(context, R.color.logo_red), PorterDuff.Mode.SRC_ATOP)//logoImageView.setColorFilter(R.color.default_red, PorterDuff.Mode.SRC_ATOP)
            resources.getString(R.string.un_favourite) -> logoImageView.setColorFilter(ContextCompat.getColor(context, android.R.color.holo_orange_dark), PorterDuff.Mode.SRC_ATOP)
        }
    }
