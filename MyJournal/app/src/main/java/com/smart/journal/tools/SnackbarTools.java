...
public class SnackbarTools {
    ...
    public static void showSettingSnackBar(final Context context, String titleInfo) {
        ...
        Snackbar snackBar = Snackbar.make(rootView, titleInfo, Snackbar.LENGTH_LONG).setAction("去设置", new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ActionTools.openSetting(context);
            }
        }).setActionTextColor(ContextCompat.getColor(context, R.color.black)).setDuration(SNACKBAR_DURATION);
    ...
    public static void showSimpleSnackbar(Context context, String message) {
        ...
        Snackbar snackBar = Snackbar.make(rootView, message, Snackbar.LENGTH_LONG).setAction("", new View.OnClickListener() {
            @Override
            public void onClick(View view) {

            }
        }).setActionTextColor(ContextCompat.getColor(context, R.color.black)).setDuration(2000);
